...
public class FruitsFragmentCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view,  final Context context, final Cursor cursor) {
        ...
        TextView quantityIncrementView = (TextView) view.findViewById(R.id.fruit_fragment_quantity_increment);
        ...
        final int columnTotal = cursor.getColumnIndex(itemsSoldContractEntry.COLUMN_TOTAL);
        ...
        final Button incrementButton = (Button) view.findViewById(R.id.fruit_fragment_increment);
        Button decrementButton = (Button) view.findViewById(R.id.fruit_fragment_decrement);
        ...
        incrementButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.v("Number of rows ","updated : "+ rowsUpdated);
            }
        });
